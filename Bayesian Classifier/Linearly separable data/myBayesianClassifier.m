...
r = 1*min(data(:,1)):.1:1*max(data(:,1)); %// x axis
r1= 1*min(data(:,2)):.1:1*max(data(:,2)); %// y axis
...
print('-djpeg', ['LS_Gaussian_PDF_Case_',num2str(caseno),'.jpg'], '-r300');
...
set(gca,'FontSize',14,'FontWeight','bold')
print('-djpeg', ['LS_Contours_Case_',num2str(caseno),'.jpg'], '-r300');
hold off
...
set(gca,'FontSize',14,'FontWeight','bold')
print('-djpeg', ['LS_Decision_Boundary_Case_',num2str(caseno),'.jpg'], '-r300');
